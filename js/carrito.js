    ...
    if (carrito.length>0){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                swal.fire({
                    html: `<h2 >Pago realizado!</h2>Gracias por tu compra!</ p><p>Enseguida enviamos tu producto!</p>
                    `,
                    icon: "success",
                    timer: "2900",
...
// _______________________________    FAVORITO    ___________________________________
...
function agregarfavorito(ProductoId){
   ...
   } else{ // _____ si No existe lo Agrega a favorito ______
